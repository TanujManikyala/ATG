...
<div class="navbar navbar-inverse navbar-top " id="menu">
    <div class="container">
        <div align="center">
			<img src="assets/img/kg.jpg" alt="Chania">
            <h3 align="center">TIME TABLE GENERATER  COMPUTER SCIENCE & ENGINEERING DEPARTMENT,KGRCET</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/K.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/kgr.jpg" alt="Chania">
        </div>
    </div>
</div>
    ...
    <div class="container set-pad">
        <div class="row text-center">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">STUDENTS</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/image.jpg" class="img-rounded"/>
                    <h3 align="center">M.TANUJ</h3>
                    <hr/>
                    <h4 align="center">AIML.<br/>CSE Department</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>KG REDDY COLLEGE OF ENGINEERING AND TECHNOLOGY</h4>
                <h4>MOINABAD</h4>
				<h4>Dist: CHILKUR</h4>
				<h4>State : TELANGANA</h4>
                <h4><strong>Call:</strong> +91 9100363859, +91 7661913737 </h4>
                <h4><strong>Email: </strong>manikyala@gmail.com</h4>
				<h4 ><strong>Website: </strong><a href="http://kgrcet.ac.in/">http://kgrcet.ac.in/</a></h4>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1"
            ...
            <hr/>
            <div>
                <a href="https://www.facebook.com/KGRCET"> <img src="assets/img/Social/facebook.png" alt=""/> </a>
                <a href=https://www.youtube.com/@kgrcet> <img src="assets/img/Social/youtube.png" alt=""/></a>
                <a href="https://www.instagram.com/kgrcet/"> <img src="assets/img/Social/instagram.jpg" alt=""/> </a>
            </div>
        </div>
