...
$conn = mysqli_connect("localhost", "id20469554_root", "a@/jC1T-JrdVL5M!", "id20469554_ttms");
...
if (isset($_POST["select_semester"])) {
    ...
    // Insert selected semester value into temp table
    $sql = "INSERT INTO temp (semester) VALUES ('$selected_semester')";
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        ...
                        $year = (int)$_POST['select_semester'] % 2;
                        ...
                        $r = mysqli_fetch_assoc(mysqli_query(mysqli_connect("localhost","id20469554_root","a@/jC1T-JrdVL5M!","id20469554_ttms"), "SELECT * from teachers
                ...
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, COMPUTER SCIENCE & ENGINEERING DEPARTMENT, KGRCET.";
